                        ...
                        <div className="grid items-center grid-cols-1 gap-12 lg:grid-cols-2">
                            <div>
                                ...
                                <h1 className="mt-4 text-4xl font-bold text-black lg:mt-8 sm:text-6xl xl:text-8xl">
                                    Browse
                                    & Buy your Medicine.</h1>
                                <p className="mt-4 text-base text-black lg:mt-8 sm:text-xl">
                                    Get your treatment fast with right doctor.
                                </p>

                                <a href="#" title=""
                                   className="inline-flex items-center px-6 py-4 mt-8 font-semibold text-white hover:text-black transition-all duration-200 bg-green-900 rounded-full lg:mt-16 hover:bg-green-300 shadow-lg focus:bg-yellow-400"
                                   role="button">
                                    Join for free
